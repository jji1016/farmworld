                        ...
                        <div class="navbar-header">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    <li class="active"><a href="#header">게시판<span class="sr-only">(current)</span></a></li>
                                    <li><a href="#welcome">쇼핑</a></li>
                                    <li><a href="#portfolio">마이농장</a></li>
                                    <li><a href="#counter">지식</a></li>
 									<li><a href="#event" class="icon"><span class="material-icons">person</span></a></li>
                                    <li><a href="#testimonial" class="icon"><span class="material-icons">shopping_cart</span></a></li>
                                    <li><a href="#blog" class="icon"><span class="material-icons">menu</span></a></li>
                                </ul>
                        </div>
                        <!-- /.navbar-collapse -->
                    </nav>
                    ...
                    <div class="slider_overlay">
                        ...
                        <div class="carousel-caption">
                            <div class="slider_text">
                                ...
                                <h2>마이농장</h2>
                                <p>농장을 키워보세요!</p>
                                <a href="" class="custom_btn">농장 둘러보기!</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="item">
                        <div class="slider_overlay">
                            ...
                            <div class="carousel-caption">
                                <div class="slider_text">
                                    <h2>혜택 알아보기</h2>
                                    <p>나라에서 지원하는 헤택을 알아보자!</p>
                                    <a href="" class="custom_btn">지원받으러가기!</a>
                                </div>
                            </div>
                        </div>
                    </div>
